...
run_cmd (assertEval "AT1 self-attn softmax"
  (tlprog!{
    tensor A(q, s)
...
run_cmd (assertEval "AT3 attn-output"
  (tlprog!{
    tensor A(q, s)
    A[q, s.] := softmax(Q[q, d] · K[s, d])
    O[q, e]  := A[q, s] · V[s, e]
...
run_cmd (assertEval "AT4 mha-batched"
  (tlprog!{
    tensor A(b, h, q, s)
...
run_cmd (assertEvalPred "AT5 cross-attn"
  (tlprog!{
    tensor A(q, s)
    A[q, s.] := softmax(Q[q, d] · K[s, d])
  })
...
run_cmd (assertEval "AT6 scaled-scores"
  (tlprog!{
    tensor A(q, s)
...
run_cmd (assertEval "AT7 transformer-block"
  (tlprog!{
...
run_cmd (assertEval "AT8 generalized-cross-attn"
  (tlprog!{
    tensor A(q, s)
...
run_cmd (assertEval "AT9 linear-attn"
  (tlprog!{
...
run_cmd (assertEval "AT10 bilinear-attn"
  (tlprog!{
    tensor S(q, s)
...
run_cmd (assertEvalPred "AT11 gqa"
  (tlprog!{
    tensor A(h, q, s)
...
run_cmd (assertEval "AT12 sparse-attn"
  (tlprog!{
    tensor A(q, s)
