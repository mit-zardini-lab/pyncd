...
/-- The constructor index of a `BrOp` (0..13) — a systematic internal tag, NOT a mapping into
...
/-- Inverse of `brOpIdx` on `0..13`; defaults to `.contract` outside that range (never hit on data
